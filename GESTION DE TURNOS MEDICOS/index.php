			...
			<div class="navbar-content">
				<ul class="pc-navbar">
                    ...
                    <li class="pc-item pc-caption">
                        ...
                        <?php if ($_SESSION ['Usuario_Nivel']==2 ){  ?>
                                        <li class="pc-item"><a href="carga.php" class="pc-link ">
                                            ...
                                            <span class="pc-mtext">Carga nueva de turnos</span></a>
                                        </li>
					                    <?php }?>
					</li>
                    ...
                    <li class="pc-item pc-caption">
                            ...
                            <?php if ($_SESSION ['Usuario_Nivel']==1 ||  $_SESSION ['Usuario_Nivel']==4){  ?>
                                    <li class="pc-item"><a href="listado.php" class="pc-link ">
                                        <span class="pc-micon"><i data-feather="layout"></i></span>
                                        <span class="pc-mtext">Listado de cargas</span></a>
                                    </li>
                                <?php }?>
                                ...
                                <?php if ($_SESSION ['Usuario_Nivel']==2 ){  ?>
                                    <li class="pc-item"><a href="listado.php" class="pc-link ">
                                        <span class="pc-micon"><i data-feather="layout"></i></span>
                                        <span class="pc-mtext">Listado de mis turnos cargados</span></a>
                                    </li>
                                <?php }?>
                                ...
                                <?php if ($_SESSION ['Usuario_Nivel']==3 ){  ?>
                                    <li class="pc-item"><a href="listadoMissAsistencia.php" class="pc-link ">
                                        <span class="pc-micon"><i data-feather="layout"></i></span>
                                        <span class="pc-mtext">Listado de mis asistencia</span></a>
                                    </li>
                                <?php }?>
